...
stanFit <- read_stan_csv(c("output/election_betaBinomialHS_model_1.csv","output/election_betaBinomialHS_model_2.csv","output/election_betaBinomialHS_model_3.csv","output/election_betaBinomialHS_model_4.csv"))
