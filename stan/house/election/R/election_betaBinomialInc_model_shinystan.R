...
stanFit <- read_stan_csv(c("output/election_betaBinomialInc_model_1.csv","output/election_betaBinomialInc_model_2.csv","output/election_betaBinomialInc_model_3.csv","output/election_betaBinomialInc_model_4.csv"))
