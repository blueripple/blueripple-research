...
stanFit <- read_stan_csv(c("output/election_betaBinomialInc_2012_1.csv","output/election_betaBinomialInc_2012_2.csv","output/election_betaBinomialInc_2012_3.csv","output/election_betaBinomialInc_2012_4.csv"))
