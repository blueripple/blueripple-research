...
stanFit <- read_stan_csv(c("output/election_betaBinomialInc_2016_1.csv","output/election_betaBinomialInc_2016_2.csv","output/election_betaBinomialInc_2016_3.csv","output/election_betaBinomialInc_2016_4.csv"))
