...
stanFit <- read_stan_csv(c("output/election_binomial_v1_model_1.csv","output/election_binomial_v1_model_2.csv","output/election_binomial_v1_model_3.csv","output/election_binomial_v1_model_4.csv"))
