...
class binomial_sepFixedWithStates_model_model final : public model_base_crtp<binomial_sepFixedWithStates_model_model> {
 ...
 public:
  ~binomial_sepFixedWithStates_model_model() { }
  
  inline std::string model_name() const final { return "binomial_sepFixedWithStates_model_model"; }
...
stan::math::profile_map& get_stan_profile_data() {
  return binomial_sepFixedWithStates_model_model_namespace::profiles__;
}
