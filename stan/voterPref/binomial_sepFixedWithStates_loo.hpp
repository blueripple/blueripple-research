...
namespace binomial_sepFixedWithStates_loo_model_namespace {
...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 14, column 0 to column 11)",
                                                      ...
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 4, column 2 to column 43)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 5, column 2 to column 19)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 6, column 9 to column 10)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 6, column 12 to column 13)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 6, column 2 to column 17)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 7, column 25 to column 26)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 7, column 2 to column 28)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 8, column 29 to column 30)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 8, column 2 to column 32)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 9, column 2 to column 19)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 10, column 31 to column 32)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 10, column 2 to column 34)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 11, column 9 to column 10)",
                                                      " (in '/Users/adam/BlueRipple/research/stan/voterPref/binomial_sepFixedWithStates_loo.stan', line 11, column 12 to column 13)",
...
class binomial_sepFixedWithStates_loo_model final : public model_base_crtp<binomial_sepFixedWithStates_loo_model> {
 ...
 public:
  ~binomial_sepFixedWithStates_loo_model() { }
  
  inline std::string model_name() const final { return "binomial_sepFixedWithStates_loo_model"; }
  ...
  binomial_sepFixedWithStates_loo_model(stan::io::var_context& context__,
    ...
    static const char* function__ = "binomial_sepFixedWithStates_loo_model_namespace::binomial_sepFixedWithStates_loo_model";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "binomial_sepFixedWithStates_loo_model_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "binomial_sepFixedWithStates_loo_model_namespace::write_array";
(void) function__;  // suppress unused var warning
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      double sigma_aState_free__;
      sigma_aState_free__ = std::numeric_limits<double>::quiet_NaN();
      
      current_statement__ = 3;
      sigma_aState_free__ = stan::math::lb_free(sigma_aState, 0);
      Eigen::Matrix<double, -1, 1> aState;
      aState = Eigen::Matrix<double, -1, 1>(J_state);
      stan::math::fill(aState, std::numeric_limits<double>::quiet_NaN());
      ...
      Eigen::Matrix<double, -1, 1> aState_free__;
      aState_free__ = Eigen::Matrix<double, -1, 1>(J_state);
      stan::math::fill(aState_free__, std::numeric_limits<double>::quiet_NaN());
      
      current_statement__ = 4;
      for (int sym1__ = 1; sym1__ <= J_state; ++sym1__) {
        current_statement__ = 4;
        assign(aState_free__, cons_list(index_uni(sym1__), nil_index_list()),
          stan::math::offset_multiplier_free(aState[(sym1__ - 1)], 0,
            sigma_aState), "assigning variable aState_free__");}
      vars__.emplace_back(alpha);
      for (int sym1__ = 1; sym1__ <= K; ++sym1__) {
        vars__.emplace_back(beta[(sym1__ - 1)]);}
      vars__.emplace_back(sigma_aState_free__);
      for (int sym1__ = 1; sym1__ <= J_state; ++sym1__) {
        vars__.emplace_back(aState_free__[(sym1__ - 1)]);}
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
      // Next line prevents compiler griping about no return
      throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***"); 
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"alpha\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" << K << "},\"block\":\"parameters\"},{\"name\":\"sigma_aState\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"aState\",\"type\":{\"name\":\"vector\",\"length\":" << J_state << "},\"block\":\"parameters\"},{\"name\":\"log_lik\",\"type\":{\"name\":\"vector\",\"length\":" << G << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
...
using stan_model = binomial_sepFixedWithStates_loo_model_namespace::binomial_sepFixedWithStates_loo_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return binomial_sepFixedWithStates_loo_model_namespace::profiles__;
}
