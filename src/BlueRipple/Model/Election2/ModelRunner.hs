...
runTurnoutModelAH year cacheStructure cmdLine tc scenarioM psData_C = K.wrapPrefix "runTurnoutModelAH" $ do
  turnoutCPAH_C <- runTurnoutModelCPAH year cacheStructure cmdLine tc scenarioM psData_C
