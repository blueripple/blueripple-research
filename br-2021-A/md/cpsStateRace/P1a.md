...
- We model the state-specific turnout of voters-of-color (VOC)
in 2012 and 2016, concluding that state-specific VOC turnout
is unlikely to be explained by demographics alone.
- SC, PA, LA, and MI have consistently above average state-specific VOC turnout.
- AZ and TX have consistently below average VOC turnout, though TX
improved significantly between 2012 and 2016.
- State-specific VOC turnout in FL and NY declined significantly between 2012 and 2016.
...
Our starting point in this post is to focus on the turnout of
...
2. This analysis should in no way take away from our firm belief
...
Now we’re positioned to be able to answer three questions about each state’s VOC turnout:

1. How much worse (or better) was each state’s VOC turnout in 2016 compared with what one would have expected?
2. How did each state’s VOC turnout change from 2012 to 2016?
3. Which states have VOC turnout patterns worth a closer look?

(1) Observed vs. expected VOC turnout in 2016 by state:
