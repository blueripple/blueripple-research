...
- We model the state-specific component of the
2016 general election turnout of voters-of-color (VOC),
concluding that it's unlikely to be explained by demographics alone.
- Something about how much is state-effect vs demographics of state
- Something about which states are where
